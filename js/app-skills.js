...
function updateLessonContent() {
    ...
    if (guidanceText) {
        guidanceText.innerHTML = `Read <span class="text-emerald-600 font-extrabold underline">${lesson.track} Mission ${lesson.number}</span> in your Skills Manual to complete today's training.`;
    }
}
